...
# save cleaned data as RDS files in the output folder ---------------------

#cleaned feeding trial format
saveRDS(ft, "Output/feeding_trial_prepped.rds")

#cleaned daily feeding trial format
saveRDS(days, "Output/feeding_trial_daily.rds")
